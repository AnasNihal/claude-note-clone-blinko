...
export const aiRouter = router({
      ...
      try {
        ...
        for await (const chunk of responseStream.fullStream) {
          if ((chunk as any)?.type === 'error') {
            const err: any = (chunk as any)?.error;
            ...
            throw new TRPCError({
              code: 'INTERNAL_SERVER_ERROR',
              message: err?.message || err?.name || 'AI stream error',
            });
          }
          yield { chunk }
        }
  ...
  rebuildEmbeddingStart: authProcedure.use(superAdminAuthMiddleware)
    .input(z.object({
      force: z.boolean().optional(),
  ...
  rebuildEmbeddingResume: authProcedure.use(superAdminAuthMiddleware)
    .mutation(async () => {
      await RebuildEmbeddingJob.ResumeRebuild();
      return { success: true };
    }),

  rebuildEmbeddingRetryFailed: authProcedure.use(superAdminAuthMiddleware)
    .mutation(async () => {
      await RebuildEmbeddingJob.RetryFailedNotes();
      return { success: true };
    }),

  rebuildEmbeddingStop: authProcedure.use(superAdminAuthMiddleware)
    .mutation(async () => {
      await RebuildEmbeddingJob.StopRebuild();
      return { success: true };
    }),

  rebuildEmbeddingProgress: authProcedure.use(superAdminAuthMiddleware)
    .query(async () => {
  ...
  testConnect: authProcedure.use(superAdminAuthMiddleware)
    .input(z.object({
      providerId: z.number(),
      modelKey: z.string(),
  ...
  getAllProviders: authProcedure.use(superAdminAuthMiddleware)
    .query(async () => {
      return await AiModelFactory.getAllAiProviders();
    }),

  createProvider: authProcedure.use(superAdminAuthMiddleware)
    .input(z.object({
      title: z.string(),
      provider: z.string(),
  ...
  updateProvider: authProcedure.use(superAdminAuthMiddleware)
    .input(z.object({
      id: z.number(),
  ...
  deleteProvider: authProcedure.use(superAdminAuthMiddleware)
    .input(z.object({
      id: z.number()
    }))
    .mutation(async ({ input }) => {
  ...
  getAllModels: authProcedure.use(superAdminAuthMiddleware)
    .query(async () => {
  ...
  getModelsByProvider: authProcedure.use(superAdminAuthMiddleware)
    .input(z.object({
      providerId: z.number()
    }))
    .query(async ({ input }) => {
  ...
  getModelsByCapability: authProcedure.use(superAdminAuthMiddleware)
    .input(z.object({
      capability: z.string()
    }))
    .query(async ({ input }) => {
  ...
  createModel: authProcedure.use(superAdminAuthMiddleware)
    .input(z.object({
      providerId: z.number(),
      title: z.string(),
      modelKey: z.string(),
  ...
  updateModel: authProcedure.use(superAdminAuthMiddleware)
    .input(z.object({
      id: z.number(),
      title: z.string().optional(),
  ...
  deleteModel: authProcedure.use(superAdminAuthMiddleware)
    .input(z.object({
      id: z.number()
    }))
    .mutation(async ({ input }) => {
  ...
  createModelsFromProvider: authProcedure.use(superAdminAuthMiddleware)
    .input(z.object({
      providerId: z.number(),
  ...
  batchCreateModelsFromProvider: authProcedure.use(superAdminAuthMiddleware)
    .input(z.object({
      providerId: z.number(),
